                  ...
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="w-full pl-11 h-12 rounded-xl bg-white/4 border border-white/8 text-white placeholder:text-white/20 focus:border-orange-500/50 focus:bg-white/[0.06] focus:ring-2 focus:ring-orange-500/10 transition-all duration-200"
